                    ...
                    <div class="card">
                        ...
                        @if(auth()->user()->id != $user->id)
                            @if(!$login_user->isFollowing($user))
                                <form action="">
                                    <button type="submit" name="follow" value="follow" class="btn btn-dark mt-2 ml-2">
                                        フォローしていません
                                    </button>
                                </form>
                            @elseif($login_user->isFollowing($user))
                                <form action="">
                                    <button type="submit" name="follow" value="unfollow"
                                            class="btn btn-success mt-2 ml-2">フォローしています
                                    </button>
                                </form>
                            @endif
                            @if(!$login_user->hasLiked($user))
                                <form action="" class="ml-2 mt-2">
                                    <button type="submit" name="like" value="like"><i class="fas fa-thumbs-up"></i>
                                    </button>
                                    {{ $user->likes_count }}
                                </form>
                            @elseif($login_user->hasLiked($user))
                                <form action="" class="ml-2 mt-2">
                                    <button type="submit" name="like" value="unlike"><i class="fas fa-thumbs-up"
                            ...
                            @if(!$login_user->hasFavorited($user))
                                <form action="" class="ml-2 mt-2">
                                    <button type="submit" name="favorite" value="favorite"><i class="fas fa-heart"></i>
                                    </button>
                                    {{ $user->favorites_count }}
                                </form>
                            @elseif($login_user->hasFavorited($user))
                                <form action="" class="ml-2 mt-2">
                                    <button type="submit" name="favorite" value="unfavorite"><i class="fas fa-heart"
                                                                                                style="color: red"></i>
                                    </button>
                                    {{ $user->favorites_count }}
                                </form>
